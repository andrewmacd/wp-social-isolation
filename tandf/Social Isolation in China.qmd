...
Most of the existing research on the subject focuses on Western highly developed societies, and this focus may limit variation on key independent variables given the similar social and institutional context in which users are embedded. In particular, we believe the case of China can provide leverage in three areas that existing theories have difficulty resolving. The first is that
