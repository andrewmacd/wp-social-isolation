...
"For example, when social media is used to facilitate offline relationships, to communicate, or to make new friends, it reduces feelings of loneliness \[140, 141\]. In contrast, when social media is used to compensate for poor social skills by replacing offline interactions with online interactions, it significantly increases loneliness \[142,143,144\]." [@lim2020]
