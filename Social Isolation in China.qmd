...
More recent studies on the subject have been significantly more mixed regarding the impact of social media on feelings of isolation. In particular, many authors have linked problematic social media use to

Primack et al. found a negative relationship between social media use and social isolation in youth in a representative sample [@primack2017].

Somewhat contrary to the previous findings, Hajek and König find that the relationship between social media and social isolation is reversed for their sample of those over 40 in Germany, suggesting the impact of social media may be influenced by age [@hajek2019].

While most of the studies agree that the causal direction flows from social media use to feelings of isolation (though see xxx), there is disagreement among authors about the specific mechanisms and causal pathways through which this relationship exists. Martilla et al. propose a more complex causal model in that social media usage predicts loneliness, which then influences measures of social well-being [@marttila2021]. Twenge et al. suggest that that while individual-level studies may not show a strong relationship between social media use and feelings of isolation, the technology may be supressing overall mean societal levels of social isolation via a generalized decrease in person to person meetups [@twenge2021].

More recent research has begun to investigate what is the primary mechanism by which social media influences feelings of social isolation.

Most of the existing research on the subject focuses on Western highly developed societies, and this focus may limit variation on key independent variables given the similar social and institutional context in which users are embedded. To address this problem, this study aims to understand how these complex dynamics interact in the non-Western setting of China. Relatively little is known about China's level of social isolation, though anecdotal evidence suggests that it is on the rise. Twenge et al.'s study found that adolescent feelings of loneliness have generally been on the rise in comparable East Asian countries [@twenge2021]. News reports have highlighted the increasing number of people who consider themselves to be online outcasts or losers (*diaosi*) [@nan2013; @szablewicz2014; @chinas2016]. We do not aim to make a direct comparison between China and Western countries but rather highlight the way in which China's unique context helps highlight how important contextual factors are in the key variable relationships.

The most important contextual factor in China is that social media space that is highly controlled online environment. Many people are aware that the Chinese government heavily censors politically sensitive content on online platforms. However, fewer are aware that the Chinese government spends as much if not more effort to clean up non-political but negative or distressing content on the Chinese internet, such as scams, instances of cyber bullying, disturbing videos, and vulgar content [@wang2020]. This control impulse also extends content the government views as spiritually polluting, such as pornography, scantily dressed women, and other escapist content. While the Chinese government and online platforms are limited in their ability to completely stamp out such content, the default is that such content is actively restricted, while US platforms tent to take a more pro-speech regulatory position [@liu2022]. If one of the main mechanisms through which social media promotes social isolation occurs is exposure to negative content, then this online environment should lead to a weaker relationship between social media use and isolation.
