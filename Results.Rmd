...
subtitle: "An Examination of the Relationship between Social Media Use and Feelings of Isolation in China"
author: 
...
ggcorrplot(cors, title="Key variables associated with connectedness", lab=TRUE, type="lower")
```
